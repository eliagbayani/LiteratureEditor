...
<input type="hidden" name="search_type" value="projectsmenu">
    ...
    <tr valign="top">
        ...
        <input onClick="spinner_on();submit()" type="radio" id="radio2" name="radio" value="proj_active" <?php if($radio == 'proj_active') echo " checked=\"checked\""; ?>> <label for="radio2">All active projects</label>
